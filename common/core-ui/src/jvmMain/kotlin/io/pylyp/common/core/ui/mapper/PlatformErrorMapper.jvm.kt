...
import io.pylyp.common.resources.internal.error_file_message
import io.pylyp.common.resources.internal.error_file_title
...
internal actual fun mapErrorPlatform(error: Throwable): UiError {
    return when (error) {
        ...
        is FileNotFoundException -> UiError(
            title = resPrintableText(Res.string.error_file_title),
            description = resPrintableText(Res.string.error_file_message),
            image = null,
            cause = error,
        )
